         ...
         <div onClick={()=>dispatch(ChangeChat({isOpen:true}))} className="chat-icon">
            ...
            {open && <div className="container-conversation" style={{height : window.innerHeight - 350}}>
                <div className="chat-open">
                    ...
                    <div style={{overflowY: "scroll",height : window.innerWidth < 550? window.innerHeight - 400: window.innerHeight - 420}} className="p-2 div-scroll bg-stone-200 flex flex-col gap-2">
