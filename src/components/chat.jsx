...
function ChatComonent() {
    ...
    const connectWithSupport = ()=>{
        setConversation(prev=>[...prev,{
            ...
            id :100,
            content :<MessageInfo loading={loading} returnedData={(data)=>{sendData(data)}} />,
            answer : ""
        }])
    }
    const reSelect =()=>{
                                    ...
                                    if(e.key == "question" ){
                                        setConversation(prev=>([...prev,{
                                            ...
                                            content : <div>
                                                ...
                                                <div>{e.answer}</div>
                                                <div >
                                                    Would you like to <span className="cursor-pointer weight-medium" onClick={reSelect}>reselect</span>,{" "}
                                                    <span className="cursor-pointer weight-medium" onClick={closeConversation}>close conversation</span>,{" "}
                                                    or <span className="cursor-pointer weight-medium" onClick={connectWithSupport}> connect with support</span>? 
                                                </div>
                                            </div>,
                                            answer : ""
                                        },]))
                                        ...
                                        setConversation(prev=>([...prev,{
                                            ...
                                            id :100,
                                            content :<><div> Do you want connect with support <span onClick={connectWithSupport} className="cursor-pointer weight-medium" >Yes</span>, {"  "}
                                            <span className="cursor-pointer weight-medium" onClick={closeConversation}>Close conversation</span> </div></>,
                                            answer : ""
                                        },]))
