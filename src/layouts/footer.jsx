...
function Footer() {
    return ( <footer>
        <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="px-5">
                <div>
                    <h5 className="weight-regular mt-10 md:mt-0 text-center sm:text-start">Get Exclusive Updates Subscribe To Our Newsletter</h5>
                    <div className="flex pt-4 pb-1 justify-center sm:justify-start ">
                        <input placeholder={"Email"} /><button className="btn-footer p-3">Subscribe</button>
                    </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 ">
                    <div className="pages">
                        <h4 className="uppercase weight-semiBold text-center sm:text-start py-3">Pages</h4>
                        <ul className="flex flex-col gap-1">
                            <li className="capitalize text-center sm:text-start cursor-pointer">Home</li>
                            <li className="capitalize text-center sm:text-start cursor-pointer">Explore Destination</li>
                            <li className="capitalize text-center sm:text-start cursor-pointer">About Us</li>
                            <li className="capitalize text-center sm:text-start cursor-pointer">List Your property</li>
                            <li className="capitalize text-center sm:text-start cursor-pointer">Contact Us</li>
                            <li className="capitalize text-center sm:text-start cursor-pointer">FAQ</li>
                        </ul>
                    </div>
                    <div className="contact">
                        <h4 className="uppercase  weight-semiBold py-3">Contact Us</h4>
                        <ul className="flex flex-col gap-1">
                        ...
                        <li className="capitalize cursor-pointer flex">
                            <a target="_blank" href="https://maps.app.goo.gl/uMgb61PbfuKiYHxq8"  rel="noopener noreferrer" className="flex items-center space-x-2">
                                ...
                                <div>Office 609, Al Bayan Building, Dubai Investments Park - 1, Dubai, UAE</div>
                            </a>
                        </li>
                        </ul>
                    </div>
