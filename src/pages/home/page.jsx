...
import ListYourProperty_2 from './sections/list_2';
    ...
    return ( <div>
      <div  className='relative'>
        <div className='img-hero'>
          <img className='w-full' src={banner_1} alt="banner" />
          <img className='w-full girl' src={girl} alt="girl" />
          
        </div>
        <div className='content-hero left-3 lg:left-10 '>
          
          <h2 className='text-main weight-bold'>{t("hero-hint-1")}</h2>
          <h1 className='text-dark weight-bold'><Retype text={t("hero-text-1")}/></h1>
        </div>
        <div className='form-search px-5 md:px-40'>
                   <div className='content-form items-center flex justify-center'>
                   <div className='grid grid-cols-2 lg:grid-cols-4   '>
                        <div className='flex items-center justify-center p-2'>
                            <InputWithIcon icon={<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                      ...
                                      </svg>} placeholder='Which Loaction?' />
                        </div>
                        <div className='flex items-center justify-center p-2'>
                            <InputWithIcon icon={<svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
                        ...
                        <div className='flex items-center justify-center p-2'>
                            <InputWithIcon icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="19" viewBox="0 0 20 19" fill="none">
                              ...
                              </svg>} placeholder='Guests ? ' />
                        </div>
                        <div className='flex items-center justify-center p-2'>
                            <button className='btn-grey !w-full'>Search</button>
                        </div>
                    </div>
                   </div>
